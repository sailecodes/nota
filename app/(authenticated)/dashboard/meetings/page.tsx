...
const meetingsData = [
  ...
  },
  {
    ...
    summary: "Introduced new sales materials, trained reps on updated product pitch, and discussed KPIs.",
    numOfActionItems: 0,
  },
];
...
export default function Meetings() {
  return (
    <section className="grid grid-cols-3 auto-rows-[300px] gap-2 p-4">
